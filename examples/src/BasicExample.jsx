    ...
    <div>
      <div style={{ backgroundColor: 'white' }}>
        <Playground
          codeText={`<Table>
        <Row>
          <Cell minWidthPx={100}>Head-1-1</Cell>
          <Cell minWidthPx={100}>Head-1-2</Cell>
          <Cell minWidthPx={300}>Head-1-3</Cell>
        </Row>
        <Row>
          <Cell minWidthPx={100}>Col-1-1</Cell>
          <Cell minWidthPx={100}>Long text for Col-1-2</Cell>
          <Cell minWidthPx={300}>Col-1-3</Cell>
        </Row>
        <Row>
          <Cell minWidthPx={100}>Col-2-1</Cell>
          <Cell minWidthPx={100}>Col-2-2</Cell>
          <Cell minWidthPx={300}>Col-2-3</Cell>
        </Row>
        <Row>
